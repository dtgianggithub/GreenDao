...
public class DBUserDao extends AbstractDao<DBUser, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property DetailsId = new Property(3, long.class, "detailsId", false, "DETAILS_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DBUSER\" (" + //
                ...
                "\"PASSWORD\" TEXT NOT NULL UNIQUE ," + // 2: password
                "\"DETAILS_ID\" INTEGER NOT NULL );"); // 3: detailsId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, DBUser entity) {
        ...
        stmt.bindLong(4, entity.getDetailsId());
    }
    ...
    public DBUser readEntity(Cursor cursor, int offset) {
        DBUser entity = new DBUser( //
            ...
            cursor.getLong(offset + 3) // detailsId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, DBUser entity, int offset) {
        ...
        entity.setDetailsId(cursor.getLong(offset + 3));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getDBUserDetailsDao().getAllColumns());
            builder.append(" FROM DBUSER T");
    ...
    protected DBUser loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        DBUserDetails details = loadCurrentOther(daoSession.getDBUserDetailsDao(), cursor, offset);
         if(details != null) {
